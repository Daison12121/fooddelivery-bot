...
TELEGRAM_BOT_TOKEN = os.getenv("TELEGRAM_BOT_TOKEN", "7942867452:AAHUPUnZaKiH-U90hFdnU4Zr3xPlAMBmEh8")
WEBHOOK_URL = os.getenv("WEBHOOK_URL", "")  # Будет установлен в Railway
...
# Корзины пользователей (в продакшне будет база данных)
user_carts = {}
...
async def menu_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    restaurant_type = query.data.split("_")[1]
...
📍 *Укажите адрес доставки* в следующем сообщении.
...
def main():
    print("🚀 Запуск FoodDelivery Bot в продакшн режиме...")
    ...
    if WEBHOOK_URL:
        ...
        print(f"🌐 Запуск с webhook: {WEBHOOK_URL}")
